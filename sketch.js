...
rocket.destroy()
  ...
  button=createSprite(608,490)
  textSize(30)
  text("Reach Saturn🪐! Press this Button👇",430,414)
  button.addImage(buttonIMG)
  button.scale=0.3;
  
 if(mousePressedOver(button)){
  gameState = 'landed'  //check this addition Vismaya
 }
...
if(gameState =='landed'){         //added
  background(255)
 
  button.visible = false
  back.destroy()
  rocket.destroy()
back1 = createSprite(669,370)
back1.addImage(surIMG)
back1.scale=1.4;

  man_stand=createSprite(261,545) 
  man_stand.addImage(man_standIMG)
 man_stand.scale=1.8;
